...
public class ReligionResourceIntTest {
    ...
    public void setup() {
        ...
        final ReligionResource religionResource = new ReligionResource(religionRepository, religionSearchRepository);
    ...
    public void createReligion() throws Exception {
        ...
        assertThat(testReligion.getReligion()).isEqualTo(DEFAULT_RELIGION);
        assertThat(testReligion.isIsactive()).isEqualTo(DEFAULT_ISACTIVE);
    ...
    public void updateReligion() throws Exception {
        ...
        Religion testReligion = religionList.get(religionList.size() - 1);
        assertThat(testReligion.getReligion()).isEqualTo(UPDATED_RELIGION);
        assertThat(testReligion.isIsactive()).isEqualTo(UPDATED_ISACTIVE);
