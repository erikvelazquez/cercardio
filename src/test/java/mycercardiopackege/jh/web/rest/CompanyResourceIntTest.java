...
import mycercardiopackege.jh.repository.CompanyRepository;
import mycercardiopackege.jh.repository.search.CompanySearchRepository;
...
public class CompanyResourceIntTest {
    ...
    public void createCompany() throws Exception {
        ...
        assertThat(testCompany.getRfc()).isEqualTo(DEFAULT_RFC);
        assertThat(testCompany.isIsactive()).isEqualTo(DEFAULT_ISACTIVE);
    ...
    public void updateCompany() throws Exception {
        ...
        assertThat(testCompany.getRfc()).isEqualTo(UPDATED_RFC);
        assertThat(testCompany.isIsactive()).isEqualTo(UPDATED_ISACTIVE);
