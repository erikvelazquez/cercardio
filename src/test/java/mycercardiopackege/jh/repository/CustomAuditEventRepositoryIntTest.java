...
import mycercardiopackege.jh.config.audit.AuditEventConverter;
import mycercardiopackege.jh.domain.PersistentAuditEvent;
...
import static mycercardiopackege.jh.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
