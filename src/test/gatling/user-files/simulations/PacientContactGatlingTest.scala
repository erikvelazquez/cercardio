...
/**
 * Performance test for the PacientContact entity.
 */
class PacientContactGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the PacientContact entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all pacientContacts")
            .get("/api/pacient-contacts")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created pacientContact")
                .get("${new_pacientContact_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created pacientContact")
            .delete("${new_pacientContact_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
