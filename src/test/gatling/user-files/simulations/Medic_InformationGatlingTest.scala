...
class Medic_InformationGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Medic_Information entity")
        ...
        .repeat(2) {
            ...
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "cp":"0", "street":"SAMPLE_TEXT", "extnumber":"SAMPLE_TEXT", "intnumber":"SAMPLE_TEXT", "phone1":null, "phone2":null, "email1":"SAMPLE_TEXT", "email2":"SAMPLE_TEXT", "facebook":"SAMPLE_TEXT", "twitter":"SAMPLE_TEXT", "instagram":"SAMPLE_TEXT", "snapchat":"SAMPLE_TEXT", "linkedin":"SAMPLE_TEXT", "vine":"SAMPLE_TEXT", "recomended":"SAMPLE_TEXT", "cvuconacyt":"SAMPLE_TEXT", "cedula":"SAMPLE_TEXT", "cedulaesp":"SAMPLE_TEXT", "curp":"SAMPLE_TEXT", "rfc":"SAMPLE_TEXT", "birthday":"2020-01-01T00:00:00.000Z", "externalhospitals":"SAMPLE_TEXT", "subid":"0", "highid":"0", "medicalinsurance":"0", "socialinsurance":"0", "responsibilityinsurance":"SAMPLE_TEXT", "sINconacyt":"SAMPLE_TEXT", "medicalinnumber":"SAMPLE_TEXT", "socialinnumber":"SAMPLE_TEXT", "responsibilityinnumber":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
